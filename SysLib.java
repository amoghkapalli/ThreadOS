...
public class SysLib {
    ...
    public static int format(int files) {
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.FORMAT, 0, files);
    }
    ...
    public static int seek(int fd, int offset, int whence) {
        ...
        args[1] = offset;
        args[2] = whence;
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.FORMAT, 0, args);
    }

    public static int close(int fd) {
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.FORMAT, 0, fd);
    }
    ...
    public static int size(int fd) {
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.SIZE, 0, fd);
    }
}